...
chiamano le classi), l'indicatore è il punteggio che ha assegnato a quella che
ha scelto. Il risultato è una mappa che dice quanto ciascun pixel conta, e si
chiama mappa di **salienza**, cioè di ciò che «salta all'occhio» (in inglese
*saliency map*, ed è così che la si trova nei programmi): l'hanno proposta
Simonyan, Vedaldi e Zisserman nel 2014 {cite}`simonyan2014deep`.
...
robustezza al rumore ciò che perde in dettaglio spaziale, e localizza in modo
affidabile l'oggetto che ha guidato la decisione.
...
sembra zero, e nel punto d'arrivo, che sta ancora più avanti sulla curva, la
pendenza scende più in basso ancora: è su un numero così che lavora un metodo
che guardi solo l'arrivo. Da lì l'errore: dichiara «non conta niente» un pixel
che è tutta la spiegazione.
...
- L’interpretabilità meccanicistica apre la scatola e prova a ricostruire i
  ...
  caselle chiedendo di accenderne pochissime per volta. La tecnica si applica
  ormai a modelli veri e grandi; che le caselle che ne escono contengano
  davvero una cosa sola resta però un giudizio dato guardandole, non una cosa
  dimostrata. Campo giovane, ma centrale per la sicurezza dei modelli grandi.
```
