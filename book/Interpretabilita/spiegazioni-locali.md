...
**locale**: riguarda una predizione sola, $f(x_0)$, non l'intero comportamento
del modello. Qui vediamo tre modi di risponderle, tre attrezzi diventati lo
...
dando più importanza ai fantasmi più vicini alla pratica vera di Maria e meno
a quelli lontani. I coefficienti di quella retta *sono* la spiegazione: «il
...
LIME sullo stesso punto può dare coefficienti diversi. Secondo, la **larghezza
...
La spiegazione dipende quindi da scelte che l'utente raramente controlla: un
...
diminuire (una monotonìa che l'importanza da impurità della prima sezione
